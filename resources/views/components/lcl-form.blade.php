<div class="row">
    <div class="col-md-6">
        <div class="mb-2">
            <label for="volumen" class="form-label">Volumen de la carga (m3)</label>
            <input type="text" class="form-control" id="volumen" name="volumen" >
        </div>

        <div class="mb-2">
            <label for="peso_total" class="form-label">Precio de la factura (USD)</label>
            <input type="text" class="form-control" id="peso_total" name="peso_total" >
        </div>
        
        <div class="mb-2">
            <label for="precio_factura" class="form-label">Primera importación</label>
            <select class="form-control" id="precio_factura" name="precio_factura" >
                <option value="FOB">FOB</option>
            </select>
        </div>
        
        <div class="mb-2">
            <label for="tipo_mercancia" class="form-label">Incoterm</label>
